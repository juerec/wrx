...
class Logger {
  ...
  public :
    ...
    Logger(const char * LogFile = "stderr", Level lev = ERROR);
    ~Logger();
    ...
    char * error_str(const char * Location, int Line, const char * FormatString, ... );
  ...
  protected :
    ...
    char * log_str(const char * Level, const char * Location, int Line, const char * FormatString, va_list * ap, int varlength);
};
